    ...
    <div className="main-content">
      <div>
        ...
        {activeButton === 1 && (
          <>
            <p>
              JavaScript'de ternary operator (a ? b : c) bir koşulu
              değerlendirir. Eğer koşul (a) doğru (true) ise, operatör b
              değerini döndürür, aksi halde (a yanlış ise, false) operatör c
              değerini döndürür.
            </p>
            <p>
...
// Yaş Grubu: Yetişkin
          ...
          `)}
            <p>
              Bir dizideki pozitif sayıları 2'ye bölelim ve 10'dan büyük
              olanları negatifine çevirelim. Bu kez, her bir sayı için önce
              10'dan büyük olup olmadığını kontrol ediyoruz (num {'>'} 10). Eğer
              sayı 10'dan büyükse, sayının tersini alıyoruz (-num), aksi halde
              sayıyı 2'ye bölüyoruz (num / 2).
            </p>
            {codeBlock(`
