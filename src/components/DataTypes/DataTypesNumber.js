...
function DataTypesNumber() {
  ...
  return (
    <div className="main-content">
      <div>
        <button className="fourth-btn">number</button>
        <>
          <p>
            JavaScript'te Number veri türü sayıları temsil etmek için
            kullanılır. Sayılar, tamsayılar (integer) ve kayan noktalı sayılar
            (floating-point) gibi farklı biçimlerde olabilir. İşte bir temel ve
            bir zor örnek:
          </p>
          <p>
            -Aşağıdaki örnekte, basit bir sayıyı Number veri türüne dönüştürmeyi
            ve temel sayı işlemlerini göstereceğiz. Bu örnekte, Number veri türü
            kullanılarak bir dize sayıyı gerçek bir sayıya dönüştürülür.
            Ardından temel matematiksel işlemler yapılır.
          </p>
          {codeBlock(`
