        ...
        {activeButton === 1 && (
          <>
            ...
            <p>
              ...
              selamlama fonksiyonu oluşturalım. Eğer yaş belirtilmezse,
              varsayılan olarak yaşın 18 olarak kabul edileceğini belirten bir
              fonksiyon oluşturalım. Bu örnekte, greetUser fonksiyonu name ve
              age adında iki parametre alır. Ancak age parametresinin varsayılan
              değeri 18 olarak atanmıştır. Eğer age belirtilmezse, fonksiyon
              otomatik olarak 18 değerini kullanır. greetUser fonksiyonunu
              çağırırken sadece isim vermemiz yeterlidir, yaş belirtmezsek
              otomatik olarak 18 kabul edilir. Böylece, fonksiyonun
              çağrılmasında bazı parametreleri isteğe bağlı hale getirebilir ve
              varsayılan değerlerle çalışmasını sağlayabilirsiniz.
            </p>
            {codeBlock(`
...
greetUser("Ayşe"); // Merhaba, Ayşe! Yaşınız: 18 (Varsayılan yaş)
          ...
          `)}
            <p>
              Aşağıdaki örnekte bir dizi içerisinde bulunan sayıları işleyen bir fonksiyon
              düşünelim. Bu fonksiyon, dizideki sayıları toplamak veya
              ...
              varsayılan olarak "add" atanmıştır. Fonksiyon içerisinde,
              operation parametresine göre farklı işlemler yapılır ve sonuç
              döndürülür. Eğer işlem türü belirtilmezse veya geçersiz bir işlem
              türü verilirse, hata mesajı döndürülür.
            </p>
            {codeBlock(`
