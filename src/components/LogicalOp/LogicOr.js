...
function LogicOr() {
  ...
  return (
    <div className="main-content">
      <div>
        <button className="fourth-btn">|| Or</button>
        <>
          <p>
            ...
            false veya falsy bir değer ise, sağdaki ifadenin değerini döndürür.
          </p>
          <p>
            -Aşağıdaki örnekte bir kullanıcının girdiği yaş bilgisini kontrol
            edelim. Eğer yaş girilmişse girilen yaş bilgisini kullanalım, yoksa
            varsayılan bir yaş değeri atayalım. Eğer userInputAge değeri null
            veya falsy bir değer ise, defaultAge olan 18 değeri kullanılacaktır.
            Aksi halde, kullanıcının girdiği yaş değeri kullanılacaktır.
          </p>
          {codeBlock(`
...
`)}
          <p>
            ...
            değer yoksa, son değeri döndürür. İlk örnekte "Gerçek Değer" truthy
            olduğu için result1 bu değeri alır. İkinci örnekte ise hiç truthy
            değer bulunmadığı için result2 "Son Değer"i alır.
          </p>
          {codeBlock(`
