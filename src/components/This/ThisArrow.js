      ...
      <div>
        ...
        {activeButton === 1 && (
          <>
            ...
            <li>
              Normal fonksiyonlar, çağrıldıkları bağlama göre dinamik olarak
              this değerini alırlar.
            </li>
            <li>
            ...
            <li>
              Arrow fonksiyonlar, tanımlandığı yerdeki bağlama göre sabit bir
              this değeri alırlar.
            </li>
            <li>
            ...
            <hr />
            <p>
              -Aşağıdaki örnekte, obj adında bir nesne tanımlanmıştır. Bu nesnenin içinde
              hem normal fonksiyon (normalFunction) hem de arrow fonksiyon
              (arrowFunction) bulunmaktadır. normalFunction içindeki this
              ifadesi, obj nesnesini temsil ederken, arrowFunction içindeki this
              ifadesi undefined döner. Çünkü arrow fonksiyonunun tanımlandığı
              bağlam, global bağlamdır ve bu nedenle name özelliği tanımsızdır.
            </p>
            {codeBlock(`
const obj = {
  name: "John",
