...
function FunctionTypesValue() {
  ...
  return (
    <div className="main-content">
      <div>
        <button className="fourth-btn">Returning a Value</button>
        <>
          <p>
            JavaScript'de bir fonksiyonun değer döndürmesi, "Returning a Value"
            olarak adlandırılır. Bu, fonksiyonun işlem sonucunu çağıran yere
          ...
          <p>
            ...
            toplamı döndürerek fonksiyonu çağırdığımızda, toplam sonucunu result
            adlı değişkende alıp konsola yazdıralım.
          </p>
          {codeBlock(`
...
console.log("Toplam: " + result); // Toplam: 13
          ...
          <p>
            ...
            çift sayıların karelerinin toplamını buluyoruz. Bu örnek, önce çift
            sayıları filtreleyerek evenNumbers dizisi oluşturur. Ardından bu
            çift sayıların karelerini squaredNumbers dizisinde saklar. Son
