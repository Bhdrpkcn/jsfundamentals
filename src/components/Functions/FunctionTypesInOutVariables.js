      ...
      <div>
        ...
        {activeButton === 1 && (
          <>
            ...
            <p>
              -Aşağıdaki örnekte dışarıdan bir değişken alıp işleyen bir
              fonksiyon oluşturalım. Bu fonksiyon, hem kendi içinde tanımlanan
              bir değişkeni hem de dışarıdan alınan değişkeni kullanacak. Bu
              örnekte, "outerValue" adında bir dış değişken tanımlanmıştır.
              "processValues" fonksiyonu "innerValue" adında bir iç değişkeni
              parametre olarak alır. Fonksiyon içerisinde, hem dış değişken olan
              "outerValue" hem de iç parametre olan "innerValue" kullanılarak
              hesaplama yapılır. Sonuç olarak 50 döner. Böylece iç ve dış
              değişkenlerin birlikte kullanılabilmesini görmüş olduk.
            </p>
            {codeBlock(`
const outerValue = 10;
...
console.log("Sonuç:", finalResult); // Sonuç: 50
          ...
          `)}
            <p>
              ...
              <p />
              -Önceki örnekteki processValues fonksiyonunu değiştirerek, iç ve
              dış değişkenleri ayrı ayrı parametre olarak almasını sağlayalım.
              <br />
