...
function FunctionTypesVarLetConst() {
  ...
  return (
    <div className="main-content">
      <div>
        <button className="fourth-btn">Var - Let - Const</button>
        <>
          <p>
          ...
          <li>
            İşlev (function) kapsamı vardır, yani değişken fonksiyon içerisinde
            tanımlanıyorsa, fonksiyon içinde geçerlidir. Fonksiyon dışında
            tanımlanıyorsa, global kapsama sahiptir.
          </li>
          <li>
          ...
          <hr />
          <p>
            Kısacası, modern JavaScript projelerinde var kullanımı yerine let ve
            const önerilir. Eğer değeri değişmeyecekse veya kesinlikle
          ...
          <p>
            ...
            çünkü blok kapsamında tanımlanmıştır ve bu nedenle sadece fonksiyon
...
console.log(globalConst); // ReferenceError: globalConst is not defined
          ...
          <p>
            ...
            içinde tanımlandığı için sadece fonksiyon içinde erişilebilirler ve
            fonksiyon dışında erişilemezler.
          </p>
          {codeBlock(`
function testFunction() {
  var localVar = 40;
